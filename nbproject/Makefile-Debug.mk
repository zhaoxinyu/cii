...
${OBJECTDIR}/assert.o: assert.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/assert.o assert.c

${OBJECTDIR}/atom.o: atom.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/atom.o atom.c
...
${TESTDIR}/tests/atom_test.o: tests/atom_test.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/atom_test.o tests/atom_test.c
...
${OBJECTDIR}/assert_nomain.o: ${OBJECTDIR}/assert.o assert.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/assert_nomain.o assert.c;\
	else  \
...
${OBJECTDIR}/atom_nomain.o: ${OBJECTDIR}/atom.o atom.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/atom_nomain.o atom.c;\
	else  \
...
${OBJECTDIR}/mem_nomain.o: ${OBJECTDIR}/mem.o mem.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mem_nomain.o mem.c;\
	else  \
...
${OBJECTDIR}/table_nomain.o: ${OBJECTDIR}/table.o table.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/table_nomain.o table.c;\
	else  \
